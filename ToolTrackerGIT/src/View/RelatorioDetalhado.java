...
public class RelatorioDetalhado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableDetalhes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome do amigo", "Ferramentas emprestadas", "Marca"
            }
        ) {
        ...
        if (tableDetalhes.getColumnModel().getColumnCount() > 0) {
            ...
            tableDetalhes.getColumnModel().getColumn(2).setResizable(false);
        }

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, 620, 460));
